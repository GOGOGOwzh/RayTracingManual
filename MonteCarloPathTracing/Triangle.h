/*****************************************************************************
* @File : D:\Games101\RayTracingManual\RayTracingManual\WhittedStyleRayTracing\Triangle.h
* @Author : Wang ZhiHao
...
public:
	...
	void CalcTriangleNormalAndArea();
	...
	virtual void Sample(Vector3f& pos, Vector3f& normale, float& pdf) override;
};